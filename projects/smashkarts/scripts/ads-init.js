...
if(isPlaywireEnabled())
{
    ...
    gtag('js', new Date());
    gtag('config', 'G-ZMN4BHJKYZ', { 'send_page_view': false, 'cookie_flags': 'samesite=none;secure' });
    gtag(
        'event',
        'ramp_js',
        {
            'send_to': 'G-ZMN4BHJKYZ',
    ...
    googletag.cmd.push(() =>
    {
        ...
        if (true === true)
        {
            (function ()
            {
                ...
                afgads.setAttribute("data-ad-client", "ca-pub-9568807537922285");
                afgads.setAttribute("src", "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-9568807537922285");
