...
gdjs.evtsExt__CameraShake__SetDefaultZoomAmplitude.conditionTrue_0 = {val:false};
gdjs.evtsExt__CameraShake__SetDefaultZoomAmplitude.condition0IsTrue_0 = {val:false};
...
{
{runtimeScene.getVariables().get("__CameraShake").getChild("DefaultAmplitudeZoom").setNumber((typeof eventsFunctionContext !== 'undefined' ? Number(eventsFunctionContext.getArgument("AmplitudeZoom")) || 0 : 0));
}}
