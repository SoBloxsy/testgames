...
gdjs.evtsExt__CameraShake__SetDefaultTranslationAmplitude.conditionTrue_0 = {val:false};
gdjs.evtsExt__CameraShake__SetDefaultTranslationAmplitude.condition0IsTrue_0 = {val:false};
...
{
{runtimeScene.getVariables().get("__CameraShake").getChild("DefaultAmplitudeX").setNumber((typeof eventsFunctionContext !== 'undefined' ? Number(eventsFunctionContext.getArgument("AmplitudeX")) || 0 : 0));
}{runtimeScene.getVariables().get("__CameraShake").getChild("DefaultAmplitudeY").setNumber((typeof eventsFunctionContext !== 'undefined' ? Number(eventsFunctionContext.getArgument("AmplitudeY")) || 0 : 0));
}}
