...
gdjs.evtsExt__CameraShake__IsShaking.condition0IsTrue_0.val = false;
{
gdjs.evtsExt__CameraShake__IsShaking.condition0IsTrue_0.val = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getVariables().get("__CameraShake").getChild("Time")) < gdjs.evtTools.variable.getVariableNumber(runtimeScene.getVariables().get("__CameraShake").getChild("Duration"));
